<div class="cross-newsletter">
   <div class="wrapper">
        ...
        <form id="form" action="https://app.mailjet.com/widget/iframe/1Ihf/2RI#" name="form" method="post">
            ...
            <input id="w-preview-fields-content-cell-field-email" placeholder="Entrez votre email" name="w-field-field-11018-61576-408533-email" required="required" type="email">

            <input id="submit_button" type="submit" value="S'inscrire"/>
